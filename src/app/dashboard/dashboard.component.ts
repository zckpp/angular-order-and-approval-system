...
import {cookie_settings, role_settings} from "../app_settings";
...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit() {
    // replace "+" generated by cookie with space
    let name = this.cookieService.get(cookie_settings.name).replace('+', ' ');
    let role = this.cookieService.get(cookie_settings.role);
    // if cookie auth is set, otherwise invalid
    this.auth = {
    ...
    if (this.auth.role === this.role.manager) this.changeStatus('pending');
